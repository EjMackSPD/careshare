...
export default function CareAIPage() {
  ...
  useEffect(() => {
    ...
    async function fetchConversations() {
      try {
        ...
        console.error(err)
        setError("Couldn't load previous CareAI conversations.")
      }
    }
  ...
  useEffect(() => {
    ...
    async function fetchConversation() {
      try {
        ...
        console.error(err)
        setError("Couldn't load that CareAI thread.")
      } finally {
  ...
  async function sendMessage(prompt: string) {
    ...
    startTransition(async () => {
      try {
        ...
        if (!response.ok) {
          throw new Error(data.error || "CareAI request failed")
        }
        ...
        setError(
          err instanceof Error
            ? err.message
            : "CareAI couldn't answer right now."
        )
      }
    })
  }
                ...
                <div className={styles.threadList}>
                  {conversations.length === 0 && (
                    <p className={styles.emptyText}>
                      Your first CareAI conversation will show up here.
                    </p>
                  )}
              ...
              <div className={styles.chatSurface}>
                <div className={styles.chatHeader}>
                  <div className={styles.chatHeaderCopy}>
                    <h2>{selectedFamily?.name || "CareAI workspace"}</h2>
                    <p>
                  ...
                  <div className={styles.guardrail}>
                    <ShieldAlert size={16} />
                    <span>Informational, not medical or legal advice</span>
                  </div>
                </div>
                ...
                <div className={styles.messageStream}>
                  {messages.length === 0 && !loadingConversation && (
                    <div className={styles.emptyState}>
                      ...
                      <h3>Ask CareAI for a grounded family snapshot.</h3>
                      <p>
                    ...
                    <article
                      ...
                      >
                        <div className={styles.messageMeta}>
                          <span>{message.role === "USER" ? "You" : "CareAI"}</span>
                          <time>
                  ...
                  <section className={styles.detailsPanel}>
                    <div className={styles.detailCard}>
                      ...
                      {contextSummary ? (
                        ...
                        <p>CareAI will show which records informed its answer.</p>
                      )}
                    </div>
                    ...
                    <div className={styles.detailCard}>
                      ...
                      {recommendations.length > 0 ? (
                        ...
                        <p>
                          CareAI will separate direct family facts from suggested
                          next steps.
                        </p>
                      )}
                    </div>
