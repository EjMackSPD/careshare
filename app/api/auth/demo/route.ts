...
export async function POST() {
  try {
    ...
    const hasFamily =
      demoUser.familyMembers && demoUser.familyMembers.length > 0;
    ...
    if (!hasFamily) {
      ...
      const tasks = [
        {
          ...
          description:
            "Get monthly blood pressure medication from CVS Pharmacy",
      ...
      const messages = [
        {
          ...
          userId: sarahUser.id,
          message:
            "Hi everyone! Just wanted to check in. Mom mentioned she needs help with her prescription pickup this week. I can grab it on Thursday if that works?",
        },
        {
          familyId: demoFamily.id,
          userId: michaelUser.id,
          message:
            "Thanks Sarah! Thursday works great. I can handle the grocery shopping tomorrow. Does anyone have the shopping list?",
        },
        {
          familyId: demoFamily.id,
          userId: demoUser.id,
          message:
            "Perfect! I'll update the shopping list in the app. Also, don't forget Mom has her cardiology appointment next week on Tuesday at 10 AM.",
        },
        {
          familyId: demoFamily.id,
          userId: emilyUser.id,
          message:
            "I can take her to the doctor appointment! I'll pick her up at 9:30 AM to make sure we're on time.",
        },
      ];
      ...
      const lifeStories = [
        ...
        },
        {
          ...
          content:
            'For 35 years, Mom dedicated her life to teaching third grade at Lincoln Elementary. She touched thousands of lives and still gets letters from former students. I remember the pride in her eyes when she received the Teacher of the Year award in 1998. She always said, "Every child deserves to feel special and capable." Her passion for education inspired me to become a teacher too.',
        ...
        },
        {
          ...
          content:
            "When I was going through a tough time in college, Grandma sat me down and shared her philosophy: \"Life isn't about waiting for the storm to pass, it's about learning to dance in the rain.\" Those words have guided me through every challenge since. She has an incredible way of making complex things simple and filling you with hope.",
      ...
      const notes = [
        {
          ...
          content:
            "Mom's blood pressure was 128/82 this morning. Within normal range. She mentioned feeling good and energetic today.",
          category: "health",
        },
        {
          familyId: demoFamily.id,
          userId: sarahUser.id,
          content:
            "Noticed Mom was a bit forgetful today about taking her afternoon vitamin. Set up a phone reminder for 2 PM daily.",
        ...
        },
        {
          ...
          content:
            "Mom walked around the block today without her cane! She seemed really proud. Physical therapy is definitely working.",
          category: "care",
        },
        {
          familyId: demoFamily.id,
          userId: emilyUser.id,
          content:
            "Attended doctor appointment today. Dr. Johnson says everything looks great. Next checkup in 6 months.",
          category: "health",
        },
      ];
