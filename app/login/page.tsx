      ...
      <div className={styles.container}>
        ...
        <div className={styles.leftPanel}>
          ...
          <h1 className={styles.tagline}>
            Elevating Family Caregiving through Shared Responsibility and
            Support
          </h1>

          <p className={styles.description}>
            As our loved ones age, their ability to manage daily life and
            finances often diminishes. Our platform empowers families by making
            caregiving a collaborative, transparent, and sustainable experience.
          </p>
