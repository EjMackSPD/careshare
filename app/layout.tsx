...
export const metadata: Metadata = {
  ...
  description:
    "A platform that helps families coordinate care for elderly loved ones. Share costs, organize events, and manage responsibilities together. Simplify family caregiving coordination.",
  keywords: [
    "family care",
    "elderly care",
    "caregiving",
  ...
  openGraph: {
    ...
    description:
      "A platform that helps families coordinate care for elderly loved ones. Share costs, organize events, and manage responsibilities together.",
    images: [
      {
