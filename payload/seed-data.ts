  ...
  },
  {
    ...
    layout: [
      ...
      },
      {
        ...
        items: [
          { title: "Family First", body: "Every feature starts with one question: does this make life easier for families?", iconKey: "heart", accentPreset: "brandBlue" },
          { title: "Shared Responsibility", body: "Caregiving is a team effort. We design tools that help distribute the load fairly.", iconKey: "users", accentPreset: "careGreen" },
          { title: "Simplicity & Transparency", body: "Complex situations need simple tools, clear communication, and transparent records.", iconKey: "sparkles", accentPreset: "warmGold" },
          { title: "Purpose-Driven", body: "We support families during one of life's most challenging journeys.", iconKey: "target", accentPreset: "familyPurple" },
        ],
      },
      {
        blockType: "cta",
